...
'''
    ...
    def calculate_cost(selected_skills):
        ...
        return final_team, team_tfs, team_cost
    ...
    for num_skills in range(4, 12):
        ...
        for i in range(10):
            ...
            max_logit_team, tfs_team,max_dm = calculate_cost(selected_skills)
            ...
            total_tfs += Team.diameter(pairs, graph)
            #print('cbr team', cbr_team)
            #total_cbr += Team.diameter(cbr_team, graph)
    ...
    plt.ylabel('Diameter Distance of Team formed')
    plt.legend()
    plt.show()
